...
create_date datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(0),
  ...
  av varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '专题在B站唯一标识',
  up_id varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'up主的唯一标识',
  img varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '专题封面',
  title varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '专题标题',
  description varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '专题描述',
  status tinyint(3) UNSIGNED NOT NULL DEFAULT 0 COMMENT '状态1可用，0禁用',
  created_at timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(0),
  updated_at timestamp(0) NULL DEFAULT NULL,
  category_id bigint(20) NULL DEFAULT NULL,
  PRIMARY KEY (id) USING BTREE,
  UNIQUE INDEX topics_av_unique(av) USING BTREE,
  INDEX topics_up_id_index(up_id) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;`

	var topic_videos = `CREATE TABLE  IF NOT EXISTS  topic_videos (
  id bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  topic_id varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '专辑id',
  av varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '视频在B站的标识',
  p varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1' COMMENT '在专辑里面的页码',
  title varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '视频标题',
  view_number int(10) UNSIGNED NOT NULL DEFAULT 1 COMMENT '观看次数',
  status tinyint(3) UNSIGNED NOT NULL DEFAULT 0 COMMENT '状态1可用，0禁用',
  created_at timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(0),
  updated_at timestamp(0) NULL DEFAULT NULL,
  PRIMARY KEY (id) USING BTREE,
  INDEX topic_videos_topic_id_index(topic_id) USING BTREE,
  INDEX topic_videos_av_index(av) USING BTREE
